...
async function main() {
    ...
    coinsbase = prompt('Enter base coin name (e.g., ETH,BNB,ADA): ').toUpperCase();
    ...
    const btcKlines = await getKlines('' + coinsbase + 'USDT', interval, sysTime, limit);
    if (!btcKlines) {
        console.log('Failed to fetch ' + coinsbase + ' K-lines data. Aborting...');
        return;
    }
