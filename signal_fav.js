...
var favs = "AIDOGE,S,NOT,AVAX,TURBO,CHZ,RUNE,MANA,HYPE,CRV,VIRTUAL,IMX,ETH,DOGE,LTC,FARTCOIN,TORN,XMR,DYDX,ARB,FLOKI,HBAR,KDA,SPS,ONE,OP,HNT,VET,FET,1INCH,ONT,YFI,KASPER,LUCE,WEMIX,RFC,ROAM,BROCCOLIF3B,XAUT,STRK,ONE,XEC,XEM,SWCH,ZIL,MKR,APE,SKL,BCH,OM,FIL,KAVA,EGLD,MAGIC,JUP,CELR,MASK,LDO,LUNC,COMP,PEPE,VINE,BABYDOGE,SHIB,BONK,SEI,TRUMP,AR,LINK,CAKE,GALA,WAVES,REZ,MNT,CRO,TON,APT,SAFE,RSR,PENDLE,BSV,IOTA,THETA,QNT,SOL,ADA,XRP,RAY,STORJ,ENS,NEO,FTT,UNI,IOTX,NRG,GMT,WLD,BTC,SNX,KSM,ICP,GRT,ORDI,BTT,NEON,RON,BB,BOME,ZRX,AIOZ,INJ,LRC,ENJ,JASMY,SUSHI,AXS,ETC,DASH,LPT,PYTH";

const https = require('https');
const httpsAgent = new https.Agent({ rejectUnauthorized: false });

// Configuration variables
const ACCESS_ID = "DD053DC012674525AEE34A8C5D093C01"; // your access id
const SECRET_KEY = "6D968D2DA5629E83B42B6F99362B87F4B5E2077104D6803B"; // your secret key
...
async function generateSignalList() {
    ...
    try {
        ...
        for (const asset of assets) {
            ...
            if(favs.indexOf(coin)==-1) continue;
